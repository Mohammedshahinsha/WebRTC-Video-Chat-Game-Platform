...
function showScreenShareControls() {
    ...
    if (!document.getElementById('screenShareControls')) {
        const controlsHTML = `
            <div id="screenShareControls" style="
                position: fixed;
                top: 10px;
                right: 10px;
            ...
            ">
                ...
                <div id="performanceChart" style="
                    ...
                    overflow: hidden;
                ">
                    <canvas id="chartCanvas" width="260" height="60" style="display: block;"></canvas>
                </div>
                ...
                <div style="display: flex; gap: 6px; margin-top: 4px;">
                    <button onclick="toggleAutoOptimize()" id="autoOptimizeBtn" style="
                        ...
                        flex: 1;
                    ">자동 최적화</button>
                    <select onchange="changeScreenShareQuality(this.value)" id="qualitySelector" style="
                        background: #333;
                        color: white;
